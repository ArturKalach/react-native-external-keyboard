...
public class BubbledKeyPressUpEvent extends Event<BubbledKeyPressUpEvent> {
  public static String EVENT_NAME = "topBubbledKeyUpPress";
  public WritableMap payload;

  public BubbledKeyPressUpEvent(int surfaceId, int id, int keyCode, KeyEvent keyEvent, boolean isLongPress) {
    super(surfaceId, id);
