...
public class BubbledKeyPressDownEvent extends Event<BubbledKeyPressDownEvent> {
  public static String EVENT_NAME = "topBubbledKeyDownPress";
  public WritableMap payload;

  public BubbledKeyPressDownEvent(int surfaceId, int id, int keyCode, KeyEvent keyEvent) {
    super(surfaceId, id);
